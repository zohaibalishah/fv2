                ...
                <div>
                  ...
                  {!displayForm && <>
                    ...
                    <GridContainer>
                      ...
                      <GridItem xs={12} sm={12}>
                        <h6 class="cls_h6 nn_sell_title">  {t("Homepageheader._Description")}</h6>
                  ...
                  <GridContainer>
                    <GridItem xs={4} sm={3}>
                      <h6 class="cls_h6 nn_sell_title">  {t("Homepageheader._IsFree")} </h6>
                    </GridItem>
                    <GridItem xs={8} sm={9}>
                  ...
                  {!isFree && (
                    <GridContainer>
                      <GridItem xs={12} sm={12}>
                        <h6 class="cls_h6 nn_sell_title">  {" "}
                          {t("Homepageheader._Rate")} <span class="validatcolor">*</span>{" "}
                  ...
                  {(buyOptionEnable && !isFree) && <GridContainer>
                      <GridItem xs={4} sm={3}>
                        <h6 class="cls_h6 nn_sell_title">  {t("Homepageheader._buyNow")} </h6>
                      </GridItem>
                      <GridItem xs={8} sm={9}>
                        <div style={{ paddingTop: "8px" }}>
                          <FormControlLabel
                  ...
                  {(instantBuy && !isFree) && <GridContainer>
                    <GridItem xs={12} sm={12}>
                      <h6 class="cls_h6 nn_sell_title">  {t("orderViewPage._shippingRate")} <span class="validatcolor">*</span>
                  ...
                  {!isFree && <GridContainer>
                    <GridItem xs={12} sm={12} className={"nn_seller_input"}>
                      <h6 class="cls_h6 nn_sell_title"> {t("Homepageheader._CurrencyCode")} </h6>
                    </GridItem>
                    <GridItem xs={12} sm={12} className="nn_seller_input nn_dropdownsell">
                      <FormControl
                        fullWidth
